...
function rollback()
{
	...
	echo "[Rollback to V2.3_app]..."
	cp -rf /home/work/V2.3.1/backup_V2.3_app/App_das_uq.tar.gz /home/das_uq/
	cd /home/das_uq/
	tar xvfz App_das_uq.tar.gz >/dev/null 2>&1
	...
	echo "[Rollback to V2.3_app finished!]"
}
