...
while true
do
	echo "		[UQ NMS V2.4 Update_Web Script]"
	echo "	"
	echo "		1.[file backup]"
...
{
	if [ ! -d "/home/work/backup/backup_V2.3_web" ];then
		echo "[/home/work/backup/backup_V2.3_web not found,the script will make it!]"
		mkdir -p /home/work/backup/backup_V2.3_web;
	fi
	echo "[backup files]"
	cd /home/omcweb/tomcat/webapps/ROOT
	rm -rf Web*
	tar czvf Web_V2.3.tar.gz * /home/das_uq/bin/systemalarm >/dev/null 2>&1
	mv -f Web_V2.3.tar.gz /home/work/backup/backup_V2.3_web
	echo "[files backup finished]"
	echo "[files backup check:including quantity and size]"
	echo "[Web_V2.3.tar.gz should be in /home/work/backup/backup_V2.3_web]"
	ls -l /home/work/backup/backup_V2.3_web/Web_V2.3.tar.gz 2>&1
...
{ 
	...
	echo "[1 files should be in /home/work/update/update_V2.4_web;]"
	cd /home/work/update/update_V2.4_web >/dev/null 2>&1
	if [ $? != 0 ];then
	echo "[folder '/home/work/update/update_V2.4_web' not found,please do the preparation first"
	break
	fi
	ls -l /home/work/update/update_V2.4_web
	echo " "
	quantity=`find /home/work/update/update_V2.4_web -type f| wc -l`
	size=`du -cb /home/work/update/update_V2.4_web/*|grep total|awk -F " " '{print$1}'`
	...
	function owner_change()
{
	...
	cd /home/work/update/update_V2.4_web/  >/dev/null 2>&1
	if [ $? != 0 ]; then
	echo "[ERROR:folder /home/work/update/update_V2.4_web/ not exist,please do [2.update file check] first!]"
	continue
	fi
	chown -R omcweb:omcweb /home/work/update/update_V2.4_web/
    chown das_uq:das_uq /home/work/update/update_V2.4_web/systemalarm
	chmod 775 /home/work/update/update_V2.4_web/*
	ls -l /home/work/update/update_V2.4_web/
	echo " "
	quantity=`find /home/work/update/update_V2.4_web -type f| wc -l`
	size=`du -cb /home/work/update/update_V2.4_web/*|grep total|awk -F " " '{print$1}'`
...
{	
	...
	cd /home/work/update/update_V2.4_web >/dev/null 2>&1
	if [ $? != 0 ];then
		echo "[folder /home/work/update/update_V2.4_web not exist,please do [2.update file check] first!]"	
	continue
	fi
	...
	cd /home/work/update/update_V2.4_web

    # update systemalarm
    rm -f /home/das_uq/bin/systemalarm
	mv /home/work/update/update_V2.4_web/systemalarm /home/das_uq/bin/
	...
	cp -rf /home/work/update/update_V2.4_web/ElementOperatorAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/element/elementManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/UpgradeFilesAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/upgrade/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/web/pollTaskListVOp.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/upgrade/batchUpgrade/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AlmCurrentalarmlogviewServiceImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/impl/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AlmCurrentalarmlogviewService.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/iface/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/AlmCurrentalarmlogviewDao.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/iface/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/DynamicSQL.hbm.xml /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/hbm/mysql/omc/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/elementDetail_resource_en_US.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementDetail/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/ProjectProcessDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/projectProject/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/pollTaskListVOp.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/pollManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
  cp -rf /home/work/update/update_V2.4_web/AfficheAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/platform/affiche/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AfficheVOp.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/platform/affiche/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DatchTaskSelectDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/pollManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DatchTaskSetDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/pollManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/pollTaskSet.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/pollManage/
  if [ $? == 0  ];then
	   let m++
	fi
		
  cp -rf /home/work/update/update_V2.4_web/alarmFrequentReport_en_US_total.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/alarmInfoList.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/alarmInfoListHis.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/alarmInfoListMask.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/alarmInfoReport_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/AlmAlarmlogHistory.hbm.xml /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/hbm/mysql/omc/AlmAlarmlogHistory.hbm.xml
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/almCurrentalarmList_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AlmCurrentalarmlogviewAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AlmCurrentalarmlogviewDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/almHistoryalarmList_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/almMaskalarmList_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/AlmMaskalarmlogviewDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/alarm/alarmInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/applicationContext-base.mysql.xml /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/bhtIE6.css /home/omcweb/tomcat/webapps/ROOT/css/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/bhtIE7.css /home/omcweb/tomcat/webapps/ROOT/css/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/deviceLog.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/log/logInfo/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/deviceLog_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DeviceLogAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/log/loginfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DeviceLogDao.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/iface/omc/log/loginfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DeviceLogDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/log/loginfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/deviceLogDetails_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DeviceLogService.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/iface/omc/log/loginfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DeviceLogServiceImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/impl/omc/log/loginfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/DialectForInkfish.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/util/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/edCommon.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementDetail/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/elementDetail.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementDetail/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementDetailAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/elementList.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/elementList.xml /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/elementList_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/elementList_en_US.xml /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementListAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementListDao.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/iface/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementListDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementListServiceImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	  cp -rf /home/work/update/update_V2.4_web/ElementOperatorDao.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/iface/omc/element/elementManage/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementOperatorDaoHibImpl$1.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementOperatorDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementOperatorServiceImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/ElementTopoDisplayAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/element/elementTopoDisplay/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/fastjson-1.2.2.jar /home/omcweb/tomcat/webapps/ROOT/WEB-INF/lib/
  if [ $? == 0  ];then
	   let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/fastjson-1.2.2-sources.jar /home/omcweb/tomcat/webapps/ROOT/WEB-INF/lib/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/idleList.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/idleList_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/IdleListDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/LoginAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/login/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/logInfo_re_en_US.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/log/logInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/mainpage.html /home/omcweb/tomcat/webapps/ROOT/html/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/mapTopoLogicGraph.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/map/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/mapTopoManager.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/map/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/NavBar.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/viewport/winxp/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/neEffectsWin.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/elementManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/pollTaskList_en_US.xml /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/element/pollManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/PollTaskListAction.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/action/omc/element/pollManage/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/protal_resource_en_US.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/viewport/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/protal_resource_zh_CN.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/viewport/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/QueryUserDefined.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/domain/pojo/omc/extendsBean/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/resource_en_US.properties /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/
  if [ $? == 0  ];then
	let m++
	fi
	cp -rf /home/work/update/update_V2.4_web/struts-omc.xml /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/systemLog_en_US.ftl /home/omcweb/tomcat/webapps/ROOT/WEB-INF/template/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/TtGetqryparamreport.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/domain/pojo/omc/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/userDefinedReport.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/report/deviceInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/UserDefinedReportDaoHibImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/dao/impl/omc/report/deviceInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/UserDefinedReportServiceImpl.class /home/omcweb/tomcat/webapps/ROOT/WEB-INF/classes/com/sunwave/service/impl/omc/report/deviceInfo/
  if [ $? == 0  ];then
	let m++
	fi
	
	cp -rf /home/work/update/update_V2.4_web/userDefinedReportVOp.js /home/omcweb/tomcat/webapps/ROOT/js/com/sunwave/view/business/omc/report/deviceInfo/
  if [ $? == 0  ];then
	let m++
	fi
