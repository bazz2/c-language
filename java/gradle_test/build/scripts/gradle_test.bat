...
set CLASSPATH=%APP_HOME%\lib\gradle_test.jar;%APP_HOME%\lib\log4j-1.2.17.jar

@rem Execute gradle_test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_TEST_OPTS%  -classpath "%CLASSPATH%" hello %CMD_LINE_ARGS%
